...
class NicknameGenerator {
    ...
    companion object {
        private val ADJ = arrayOf("Bystry", "Wesoły", "Cichy", "Gorący", "Szmaragdowy")
        private val NOUN = arrayOf("Lis", "Smok", "Pingwin", "Jeż", "Jednorożec")

        fun generateRandom(): String {
            return SecureRandom().let { rnd ->
                 (ADJ[rnd.nextInt(ADJ.size)] + NOUN[rnd.nextInt(NOUN.size)] + (100 + rnd.nextInt(900)))
            }
        }
    }
}
